...
exports.AuthApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authPost: function (body, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (body === null || body === undefined) {
                                throw new base_1.RequiredError("body", "Required parameter body was null or undefined when calling authPost.");
                            }
                            localVarPath = "/auth";
                            localVarUrlObj = new URL(localVarPath, "https://example.com");
                            if (configuration) {
    ...
    return {
        ...
        authGet: function (options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authGet(options)];
                        case 1:
        ...
        authPost: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.AuthApiAxiosParamCreator(configuration).authPost(body, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
exports.AuthApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        authGet: function (options) {
            return exports.AuthApiFp(configuration)
                .authGet(options)
...
var AuthApi = /** @class */ (function (_super) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authGet = function (options) {
        var _this = this;
        return exports.AuthApiFp(this.configuration)
            .authGet(options)
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.authPost = function (body, options) {
        var _this = this;
        return exports.AuthApiFp(this.configuration)
            .authPost(body, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
