...
exports.RoutesApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        routesDepDestGet: function (dep, dest, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (dep === null || dep === undefined) {
                                throw new base_1.RequiredError('dep', 'Required parameter dep was null or undefined when calling routesDepDestGet.');
                            }
                            // verify required parameter 'dest' is not null or undefined
                            if (dest === null || dest === undefined) {
                                throw new base_1.RequiredError('dest', 'Required parameter dest was null or undefined when calling routesDepDestGet.');
                            }
                            localVarPath = "/routes/{dep}/{dest}"
        ...
        routesDepDestGet: function (dep, dest, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.RoutesApiAxiosParamCreator(configuration).routesDepDestGet(dep, dest, options)];
                        case 1:
...
exports.RoutesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        routesDepDestGet: function (dep, dest, options) {
            return exports.RoutesApiFp(configuration).routesDepDestGet(dep, dest, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var RoutesApi = /** @class */ (function (_super) {
     ...
     * @memberof RoutesApi
     */
    RoutesApi.prototype.routesDepDestGet = function (dep, dest, options) {
        var _this = this;
        return exports.RoutesApiFp(this.configuration).routesDepDestGet(dep, dest, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return RoutesApi;
}(base_1.BaseAPI));
